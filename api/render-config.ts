...
import { renderNeon, renderNeonWithCSS } from '../renderer/render';
...
export default async function handler(
  ...
  // Allow all origins for now (can be restricted to specific domains later)
  ...
  const css = `
    @import url('https://fonts.googleapis.com/css2?family=Audiowide&family=Bungee&family=Russo+One&family=Fredoka+One&family=Knewave&family=Monoton&family=Orbitron:wght@600&family=Black+Ops+One&family=Geostar&family=Kranky&family=Righteous&family=Chewy&family=Staatliches&family=Tilt+Neon&family=Luckiest+Guy&display=swap');
